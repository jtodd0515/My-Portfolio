...
export default class MeCard extends Component {
    ...
    render() {
        ...
        <Card className="card container" bg="transparent" style={{ width: '50rem' }}>
            ...
            <Card.Img className="card-img" variant="left" src='./Components/Images/Headshots.jpg' alt="Profile Headshot" />
            <Button className="button" variant="primary" href="./Components/Resume/Resume-pdf.pdf">Resume</Button>
                <Card.Body>
